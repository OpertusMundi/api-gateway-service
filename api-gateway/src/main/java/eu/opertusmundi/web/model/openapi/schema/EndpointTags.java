...
public class EndpointTags {
    ...
    public final static String ConsumerSubscriptionBilling = "Consumer Subscription Billing";
    ...
    public final static String ProviderSubscriptionBilling = "Provider Subscription Billing";
